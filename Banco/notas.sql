...
CREATE TABLE `beneficiarios` (
  ...
  UNIQUE KEY `id_beneficiario_UNIQUE` (`id_beneficiario`)
...
INSERT INTO `beneficiarios` VALUES ('1','Fillipe Horas Palhares'),('2','Pedro lucio');
...
-- Dump completed on 2020-06-22 18:18:10
